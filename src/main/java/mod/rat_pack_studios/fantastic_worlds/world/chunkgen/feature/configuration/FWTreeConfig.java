...
{
    protected FWTreeConfig(BlockStateProvider blockStateProvider, TrunkPlacer trunkPlacer, BlockStateProvider blockStateProvider2, FoliagePlacer foliagePlacer, Optional<RootPlacer> optional, BlockStateProvider blockStateProvider3, FeatureSize featureSize, List<TreeDecorator> list, boolean bl, boolean bl2) {
    ...
    /*
    public static final Codec<FWTreeConfig> CODEC = RecordCodecBuilder.create((builder) ->
    {
        ...
        ).apply(builder, (BlockStateProvider t1, BlockStateProvider t2, BlockStateProvider t3, BlockStateProvider t4, BlockStateProvider t5, BlockStateProvider t6, Integer t7, Integer t8, List<TreeDecorator> t9) -> new FWTreeConfig(, t1, , t2, , t3, , t4, , t5, , t6));
    });
    ...
    protected FWTreeConfig(BlockStateProvider vineProvider, BlockStateProvider hangingProvider, BlockStateProvider trunkFruitProvider, BlockStateProvider altFoliageProvider, int minHeight, int maxHeight, List<TreeDecorator> decorators) {
    ...
    public static class Builder<T extends Builder>
    {
        ...
        public FWTreeConfig build()
        {
            return new FWTreeConfig(this.trunkProvider, this.foliageProvider, this.vineProvider, this.hangingProvider, this.trunkFruitProvider, this.altFoliageProvider, this.minHeight, this.maxHeight, this.decorators);
        }
    }*/
}
